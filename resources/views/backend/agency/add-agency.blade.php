...
<form ui-jp="parsley" method="post" id="add_agency" action="{!! route('post.create.agency') !!}" enctype="multipart/form-data">
<div class="app-header white box-shadow">
<div class="navbar">
    <div style="float:left;" class="title_form">
        <a class="p-themmoi" style="margin-left:0px;cursor:pointer;    font-size: 14pt;
    font-family: 'Roboto Black';">Thêm đại lý</a>
    </div>
                            ...
                            <input type="hidden" value="{{csrf_token()}}" name="_token">
                             <div class="form-group" >
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                                <input type="text"  placeholder="Tên đại lý" class="form-control thong-tin" name="name_agency" required value="{!! Request::old('name_agency') !!}" > 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2 form-control-label ">Người đại diện</label>
                                          <div class="col-sm-10">
                                               <input style="" type="text"  class="form-control thong-tin"  placeholder="Người đại diện" required name="representative" value="{!! Request::old('representative') !!}"> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2 form-control-label ">Subdomain</label>
                                          <div class="col-sm-10">
                                               <input style="" type="text" class="form-control thong-tin"  placeholder="Chỉ gồm chữ thường và số" name="domain" value="{!! Request::old('domain') !!}"> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2  form-control-label ">Phone</label>
                                          <div class="col-sm-10">
                                               <input type="text"   placeholder="Số điện thoại" class="form-control thong-tin" name="phone" required value="{!! Request::old('phone') !!}"> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2 form-control-label ">Email</label>
                                          <div class="col-sm-10">
                                               <input type="email"  placeholder="Email" class="form-control thong-tin" name="email" required value="{!! Request::old('email') !!}"> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2 form-control-label ">Mật khẩu</label>
                                          <div class="col-sm-10">
                                               <input type="text"  class="form-control thong-tin"  placeholder="Mật khẩu" name="password" required value="{!! Request::old('password') !!}" > 
                                          </div>                       
                                    </div>  
                            </div>   
                       </div>  
          ...
          <div class="col-sm-6" style="padding-bottom:50px !important;">
            <div class="box" style="min-height:408px" >
              <div class="box-header">
                ...
                <input type="text" id="vitri" style="display: none;" name="location"></input>
                ...
                <div class="form-group" style="margin-top:20px">
                  ...
                  <div class="col-sm-10" >
                       <input type="text" class="form-control thong-tin" id="address"  placeholder="Địa chỉ" name="address"> 
                  </div>                       
                </div> 
            </div> 
          </div>
