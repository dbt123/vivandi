   ...
   <div class="app-body" id="view">
    ...
    <div class="padding" style="padding-top:0px !important; padding-bottom:0px;">
     ...
     <?php  $baiviet = App\Permission::where('key', 'like', '%bai_viet')->get();
            ...
            $daily = App\Permission::where('key','like','%dai_ly')->get();
            $congtrinh = App\Permission::where('key','like','%cong_trinh')->get();
            $khieunai = App\Permission::where('key','like','%khieu_nai')->get();
            $thongke = App\Permission::where('key','like','%thong_ke')->get();
