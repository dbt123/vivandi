                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td style="padding-top:5px;">
                      <?php
                        $a = route('getProDetail',['slug'=>$item->slug,'id'=>$item->frame_id]);
                        $pieces = explode('.', $a);
                      ?>
                      @if (sizeof($pieces)==2)
                      ...
                      @endif
                      @if (sizeof($pieces)==3)
                      <a href="{{route('getProDetaildomain',['slug'=>$item->slug,'id'=>$item->frame_id])}}">{!! $item->name !!}  </a>
                      @endif
                    </td>
                    <td style="padding-top:5px;">
                      {!! $item->quantity !!}
                  ...
                  <?php $SELL_ALL = ((float)$order->total*(float)$order->percent)/100; ?>
                  <tr>
                    <td style="padding-top:5px;">
                      Giảm giá
                    </td>
                  ...
                  <tr>
                    ...
                    <td style="padding-top:5px;" class="mobile">
                      <b>{!! number_format((int)($order->total - $SELL_ALL),0,'','.') !!} đ</b>
                    </td>
                  </tr>
                  @endif
                  @if(!$order->percent && $order->discount)
                  <?php $SELL_ALL = ((float)$order->discount); ?>
                  <tr>
                    <td style="padding-top:5px;">
                      Giảm giá
                    </td>
               ...
               <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td class="left" style="padding-top:10px; text-align:center;">
                      <img class="left" style="width: auto; height: auto; max-width: 250px" src="@if($system->img_logo){!! asset($system->img_logo) !!}@endif" alt="Company Name">
                    </td>
                  </tr>
                </table>
