...
<div class="navbar">
    	...
    	min-width:100px; background-color:#F2F2F2">TẠO</button>
		@endif
		</div>
</div>
</div>
	 <div class="app-body" id="view">
							...
							<div class="row">
								<div class="col-sm-12" style="">
						            ...
						            <div class="form-group">
						              ...
						              <input type="number"  type="text" class="form-control" name="assurance" value="{{ $frame->assurance }}"  >
						            </div>
								</div>
				         	</div>	 
		                  </div>
		...
		<!-- 		    <div class="col-sm-6 item">
					...
					<div class="col-sm-6 item">
				        <div class="box">
				          <div class="box-header"><h2>File</h2></div>
				          <div class="box-body">
							<div class="row">
								<div class="col-sm-12">
									<input type="hidden" value="{{csrf_token()}}" name="_token">
						              ...
						              <p style="margin-bottom:10px;line-height:0px">
						               <p id="file_preview" style="max-height:200px;" >{{$e}}</p>
						              </p>
						              <label for="file_upload">
						                <a class="btn info">Upload file</a>
						              </label>
						              <input type="file" style="display:none" class="form-control" name="file_upload" id="file_upload"  >                    
						            </div>    
								</div>
				         	</div>	 
		                  </div>
