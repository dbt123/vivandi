                            ...
                            <input type="hidden" value="{{csrf_token()}}" name="_token">
                             <div class="form-group" >
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                                <input type="text" required placeholder="Tên khách hàng" class="form-control thong-tin" name="full_name" > 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                               <input type="text" required  placeholder="Số điện thoại" class="form-control thong-tin" name="phone" value=""> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
                                          <label class="col-sm-2 form-control-label ">Địa chỉ</label>
                                          <div class="col-sm-10">
                                               <input type="text" required class="form-control thong-tin"  placeholder="Địa chỉ" name="address" value=""> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
