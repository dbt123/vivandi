...
if(in_array($route_name,['add.agency','edit.agency','list.dai.ly','frame.agency.list','list.cong.trinh','frame.contruct','edit.contruct','list.feedback','re.agency','agency.order.list','agency.order.show','agency.list.event','agency.create.event'])){
  $active = 10;
}
?>
  <ul class="nav" ui-nav>
    ...
    @endif
    @if(session('admin')->can(['them_dai_ly', 'sua_dai_ly','xoa_dai_ly','them_san_pham_dai_ly','xoa_san_pham_dai_ly','danh_sach_dai_ly','danh_sach_cong_trinh','danh_sach_khieu_nai','danh_sach_thong_ke','gan_san_pham_cong_trinh','xoa_san_pham_cong_trinh','sua_cong_trinh','xoa_cong_trinh','duyet_khieu_nai','xoa_khieu_nai']))
    <li @if($active ==10) class="active" @endif>
      ...
      <ul class="nav-sub">
      @if(session('admin')->can('danh_sach_dai_ly'))
        <li ui-sref-active="active">
          <a href="{!! route('list.dai.ly') !!}" ><span class="nav-text">Đại lý</span></a>
        </li>
      @endif  
      @if(session('admin')->can('danh_sach_cong_trinh')) 
        <li ui-sref-active="active">
          <a href="{!! route('list.cong.trinh') !!}" ><span class="nav-text">Công trình</span></a>
        </li> 
      @endif
      @if(session('admin')->can('danh_sach_khieu_nai'))  
        <li ui-sref-active="active">
          <a href="{!! route('list.feedback') !!}" ><span class="nav-text">Khiếu nại</span></a>
        </li>
      @endif  
      @if(session('admin')->can('danh_sach_thong_ke'))
        <li ui-sref-active="active">
          <a href="{!! route('re.agency') !!}"><span class="nav-text">Thống kê</span></a>
        </li>
      @endif 
      <li ui-sref-active="active">
          <a href="{!! route('agency.order.list') !!}" ><span class="nav-text">Đơn hàng</span></a>
        </li>
      <li ui-sref-active="active">
          <a href="{!! route('agency.list.event') !!}" ><span class="nav-text">Event</span></a>
        </li>
      </ul>
    </li> 
