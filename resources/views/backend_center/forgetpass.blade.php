  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      <div class="m-b text-sm">
        Hãy nhập các thông tin sau để lấy lại mật khẩu
      </div>
      @if ($errors->any())
      ...
      <form name="form" action="{{ route('login.center.forget') }}" method="post" >
        ...
        <button type="submit" class="btn primary btn-block p-x-md">Tiếp tục</button>
      </form>
