  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    <div class="navbar company">
      <div class="">
          ...
          ?>
              <img style="width: 150px; margin-bottom: 10px;" src="{!! $img_logo !!}" alt="{!! $img_logo !!}">
      </div>
    </div>
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form name="form" action="{!! route('login.center') !!}" method="post" >
         <input type="hidden"  name="_token" value="{!! csrf_token() !!}"/>
        <div class="md-form-group float-label">
          <input type="text" class="md-input"  name="email" required>
          <label style="font-size:10pt;">Email</label>
        </div>
        <div class="md-form-group float-label">
        ...
        <button type="submit" class="btn primary btn-block p-x-md">Đăng nhập</button>
          ...
          <div class="p-v-lg text-center">
            <div class="m-b"><a style="font-weight: 400;float: right;display: inline-block;margin-top: -6px; margin-right: 5px;" ui-sref="access.forgot-password" href="{{ route('login.center.forget') }}" class="text-primary _600">Quên mật khẩu</a>
            </div>
          </div
    </div>
