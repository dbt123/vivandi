...
<form ui-jp="parsley" method="post" id="add_agency" action="{{ route('info.center.post') }}" enctype="multipart/form-data">
<div class="app-header white box-shadow">
<div class="navbar">
  <div style="float:left;" class="title_form">
        <a class="p-themmoi" style="margin-left:0px;cursor:pointer;    font-size: 14pt;
    font-family: 'Roboto Black';">Thông tin đại lý</a>
    </div>
   ...
   <div class="app-body" id="view">
    ...
    <div class="padding">
         <div class="row">
                            ...
                            <input type="hidden" name="agency_id" value="{!! $agency->id !!}">
                             <div class="form-group" >
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                               <input style="" type="text" class="form-control thong-tin"  placeholder="Chỉ gồm chữ thường và số " name="domain" disabled value="{!! $agency->subdomain !!}"> 
                                          </div>                       
                                    </div>
                                    <div class="form-group">
          ...
          <div class="col-sm-6" style="padding-bottom:50px !important;">
            <div class="box" style="min-height:461px" >
              <div class="box-header">
                ...
                <div class="col-md-12" id="map_xyz" style="width:98%; height:350px; padding:10px;margin-bottom: 15px;"></div> 
