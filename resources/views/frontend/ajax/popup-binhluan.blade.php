...
<div class="popup-interactive-content">
    ...
    <div class="scrollbar-dynamic scrollbar-dynamic-interactive">
        <table class="interactive">
            <tr>
                <td class="interactive-active d_ajax_binhluan" data-id="{!! $frame->id !!}"><a href="">@if(sizeof($comment) < 10) <span>0{!! sizeof($comment) !!}</span> @else <span>{!! sizeof($comment) !!}</span> @endif B<em class="viettat">ình </em><em class="viettat-dot">.</em>luận</a></td>
