    ...
    <div class="scrollbar-dynamic scrollbar-dynamic-interactive">
        <table class="interactive">
            <tr>
                ...
                <td class="interactive-active d_ajax_luotmua" data-id="{!! $frame->id !!}"><a href="">@if(sizeof($order) < 10) <span>0{!! sizeof($order) !!}</span> @else <span>{!! sizeof($order) !!}</span> @endif L<em class="viettat">ượt </em><em class="viettat-dot">.</em>mua</a></td>
