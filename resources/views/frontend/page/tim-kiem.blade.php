                    ...
                    <div class="content-right-model">
                        ...
                        @if(sizeof($group_attr0))
                            @foreach($group_attr0 as $key => $item) 
                                <a href="{!! route('get.Category',['id'=>$item->id,'slug'=>$item->slug]) !!}"><h5 style="    text-transform: uppercase;"   {{-- class="content-right-model-active" --}} >{!! $item->name !!}</h5></a>
                            @endforeach
                        @endif
                    </div>
...
<script>
    ...
    $(document).on('click','.filter_click',function(e){
        ...
        $.ajax({
            ...
            type:"post",
            url:"{{route('load.filter.click.search')}}",
    ...
    $(document).on('click','.d_search',function(e){
        ...
        page = $(this).data('page');
            ...
            type:"post",
            url:"{{route('ajax.pagination.search')}}",
