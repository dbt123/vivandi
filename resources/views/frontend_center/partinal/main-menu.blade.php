...
<header>
            ...
            <div class="row">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-right wrap-navbar-center">
                        <form class="navbar-form navbar-left" action="{!! route('domain.search.frame') !!}">
    ...
    <div class="container search-rps"><form action="{!! route('domain.search.frame') !!}"><input type="text" name="search"></form></div>
</header><!--Popup tra cứu đơn hàng-->
